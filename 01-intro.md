...
7. Tabキーを押して「追加」ボタンに移動してEnter（ショートカット・キーはAlt + A）
8. 「入力ジェスチャーの登録」という読み上げが聞こえたら、Yキーを押す
...
以下の手順で、マウス・ポインターをGoogle Chromeのアドレスバーに移動することができます。

1. Ctrl + Lを押してアドレスバーにフォーカスを移動
...
Ctrl + Lを押すことで、アドレスバーに移動することができます。
アドレスバーに検索語を入力してEnterを押すと、デフォルトの検索エンジンで検索が実行され、検索結果のページに移動します。
また、特定のページのURLを入力してEnterを押すと、そのページに移動します。
Enterの代わりにAlt + Enterを押すと、検索結果や移動先のページが新しいタブで開かれます。

Alt キーを押すことで、Chromeメニューに移動できます。
Chromeメニューに移動した上で、左右矢印キーを用いることで、ツールバーの各項目に移動することができます。
...
タブ・ブラウジングでは、1つのウィンドウ内に複数のタブが表示され、タブを切り替えることで異なるページを表示することができます。
...
ウィンドウの最大化は、Alt + Spaceを押して表示されるメニューでXを押すか、Win + ↑を押すことで行えます。
...
* スクリーン・リーダーのサポートを有効にする：Ctrl + Alt + Z -- 「スクリーンリーダーのサポートが有効になっています。」と読み上げられます。
* 点字表示を有効にする：Ctrl + Alt + H -- 「点字表示を有効にしました。」と読み上げられます。
...
Alt + Fを押すと、メニューバーのファイル・メニューに移動します。
...
メニューバーの操作は、基本的にWindowsの一般的なアプリケーションと同様で、左右矢印キーを使ってメニューバー上を移動し、Enterを押すことでメニューを開くことができます。

メニューバーにフォーカスがあるときにTabキーを押すと、ツールバーに移動します。
ツールバー上での操作も、基本的にはWindowsの一般的なアプリケーションと同様で、左右矢印キーを使ってツールバー上を移動し、Enterを押すことでツールバーのボタンを押すことができます。

メニューバーやツールバー、コンテンツの編集領域以外の操作をする場合は、Ctrl + Alt + ,とCtrl + Alt + .を使って、それぞれ前の項目と次の項目に移動することができます。
このような場合、ブラウズ・モードで操作を行う方が便利なこともあります。

### ショートカット・キー一覧の表示

Google Workspaceの各種アプリケーションでは、フォーカス・モードで ? （Shift + /）または Ctrl + / を押下することで、ショートカット・キー一覧を表示することができます。
